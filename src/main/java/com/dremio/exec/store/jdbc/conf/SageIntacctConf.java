...
@SourceType(value = "SageIntacctARP", label = "SageIntacct",uiConfig = "sageintacct-layout.json")
public class SageIntacctConf extends AbstractArpConf<SageIntacctConf> {
  private static final String ARP_FILENAME = "arp/implementation/sageintacct-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.sageintacct.SageIntacctDriver";
